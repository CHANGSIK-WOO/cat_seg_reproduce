...
def parse_args():
    ...
    parser.add_argument('--checkpoint', nargs='?', default=None, help='(optional) MMEngine checkpoint .pth; omit when using d2_weights_path')
    parser.add_argument(
        '--work-dir',
...
def main():
    ...
    # Only load MMEngine-style checkpoint when provided
    if args.checkpoint:
        cfg.load_from = args.checkpoint    
