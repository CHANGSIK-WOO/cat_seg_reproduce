...
def add_owss_cat_seg_config(cfg):
    """
    Add config for MASK_FORMER.
    """
    # data config
    ...
    # OW-OVSS (Unknown via OW-OVD ideas)
    cfg.MODEL.OWOVSS = CN()
    cfg.MODEL.OWOVSS.ENABLE = False
    cfg.MODEL.OWOVSS.ATTR_PATH = "datasets/owovss/attributes.pt"
    cfg.MODEL.OWOVSS.VSAS_SELECTED_PATH = "work_dirs/owovss/vsas_selected.json"
    cfg.MODEL.OWOVSS.DISTRIBUTION_PATH = ""   # e.g., "paper_repeat/.../sowod_distribution_sim1.pth"
    cfg.MODEL.OWOVSS.GT_EMBED_PATH = ""       # e.g., "data/.../t1_gt_embeddings.npy" (원하면 텍스트 임베딩 override)    
    cfg.MODEL.OWOVSS.BINS = 101
    cfg.MODEL.OWOVSS.ALPHA = 0.75
    cfg.MODEL.OWOVSS.BETA = 0.3
    cfg.MODEL.OWOVSS.GAMMA = 10
    cfg.MODEL.OWOVSS.UNKNOWN_CHANNEL = True
    cfg.MODEL.OWOVSS.WARMUP_EPOCHS = 1  # VSAS 분포 구축 epoch 수